...
* **Standalone Executable** *(Recommended, no Python required)*:  
  [Download PS3RPD_GUI.exe v2.1.2](https://github.com/TheAndromedaCat/PS3-Rich-Presence-for-Discord/releases/download/2.1.2/PS3RPD_GUI.exe)
* **Python Source Files** *(Requires Python 3)*:  
  [Download PS3RPD-GUI-v2.1.2-Python.zip](https://github.com/TheAndromedaCat/PS3-Rich-Presence-for-Discord/releases/download/2.1.2/PS3RPD-GUI-v2.1.2-Python.zip)  
  Extract the ZIP archive and run `python start.py` or `python PS3RPD_GUI.py`.

#### CLI Version (Terminal / Command Line)
* **Standalone Executable** *(No Python required)*:  
  [Download PS3RPD.exe v2.1.2](https://github.com/TheAndromedaCat/PS3-Rich-Presence-for-Discord/releases/download/2.1.2/PS3RPD.exe)
* **Standalone Python File**:  
  [Download PS3RPD.py v2.1.2](https://github.com/TheAndromedaCat/PS3-Rich-Presence-for-Discord/releases/download/2.1.2/PS3RPD.py)  
